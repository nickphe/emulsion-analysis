...
# save csv files of phase diagram data
    dt = pd.DataFrame({"temp": temp_list, "ns_den": ns_den_list, "ns_dil": ns_dil_list})
    ...
    with plt.style.context(["science","nature"]):
        ...
        ax.plot(ns_den_list, temp_list, linestyle = "", marker = "o")
        ax.plot(ns_dil_list, temp_list, linestyle = "", marker = "o")
